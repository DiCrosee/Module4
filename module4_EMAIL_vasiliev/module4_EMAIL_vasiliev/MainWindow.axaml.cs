...
namespace module4_EMAIL_vasiliev;
...
public partial class MainWindow : Window
{
    ...
    private void SendTestResult_OnClick(object? sender, RoutedEventArgs e)
    {
        ...
        ValidationResultTBlock.Text = validationResult ? "Email не содержит запрещенные символы" : "Email содержит запрещенных символов";
    ...
    private async void GetDataFromApi_OnClick(object? sender, RoutedEventArgs e)
    {
        ...
        var content = await httpClient.GetStringAsync("http://127.0.0.1:4444/TransferSimulator/email");
