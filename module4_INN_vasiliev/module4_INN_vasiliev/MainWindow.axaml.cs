...
namespace module4_INN_vasiliev;
...
public partial class MainWindow : Window
{
    ...
    private void SendTestResult_OnClick(object? sender, RoutedEventArgs e)
    {
        ...
        ValidationResultTBlock.Text = validationResult ? "ИНН не содержит запрещенные символы" : "ИНН содержит запрещенных символов";
    ...
    private async void GetDataFromApi_OnClick(object? sender, RoutedEventArgs e)
    {
        ...
        var content = await httpClient.GetStringAsync("http://127.0.0.1:4444/TransferSimulator/inn");
